...
<p>
<ul>
<li><em>color</em> can be a color name, a hex color (#ABC or #FFEEEE), or rgb(12,42,43)</li>
<li><em>duration</em> is the time in milliseconds to glow (default is 1000, or 1 second)</li>
<li><em>steps</em> is the number of color changes to make in the glow effect. Default is 50.</li>
</ul>
<p>Pass null or false for any value which you want to use the default. All arguments are optional.</p>
...
<p>Well, it's lighter weight than the whole UI library, and the $.animate interpolation doesn't seem to work correctly with non-white background colors.</p>
<p>So I wrote this, it was quick and dirty, and it understands all of the colors out there, has similar options, and is tiny.</p>
<h1>Releases</h1>
<ul>
<li><strong>September 27th, 2009</strong>
	<ul>
		...
		<li>Tagged glowed items to avoid glowing the same item at the same time</li>
	</ul>
</li>
...
<h1>Download</h1>
<ul>
<li><a href="http://static.marketruler.com/share/zesk/jquery/jquery.glow.js">Download jQuery Glow Plugin (Minified)</a></li>
<li><a href="http://test.static.marketruler.com/share/zesk/jquery/jquery.glow.js">Download jQuery Glow Plugin (Uncompressed)</a></li>
</ul>
<h1>Source code</h1>
...
document.write(p);
</script><noscript><strong>You need JavaScript to view this page.</strong></noscript>
...
<h1>Reverse color test 2</h1>
	<blockquote class="background-test">
		Another color, entirely.
	</blockquote>
