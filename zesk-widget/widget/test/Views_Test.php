...
class Views_Test extends TestWidget {
	...
	public function test_View_Currency_format(): void {
		$this->assertEquals(View_Currency::format($this->application, '5.512', '$'), '$5.51');
		$this->assertEquals(View_Currency::format($this->application, '5.512', '&euro;'), '&euro;5.51');
	}
}
