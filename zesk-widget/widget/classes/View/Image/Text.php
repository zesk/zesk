...
class View_Image_Text extends View {
	...
	private static function bbox($box) {
	...
	public function render(): string {
		...
		$this->debugLog("Font: $font");
		$this->debugLog("Text: $text");
		...
		$this->debugLog(_dump($box));
		$this->debugLog("Offset: $xoff,$yoff");
		$this->debugLog("Image: $width x $height");
		$this->debugLog("Bounds: $textwidth x $textheight");
		...
		$url_prefix = Directory::addSlash($this->option('url_prefix', $this->application->url('/cache/image-text')));
		$absolute_cache_path = Directory::addSlash(Directory::removeDots($cache_path));
	...
	public static function vertical(Application $application, $text, $attributes = false) {
		...
		$w = $application->widgetFactory(View_Image_Text::class, $attributes);
