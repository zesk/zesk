...
class Text_Test extends Test_Unit {
    ...
    public function test_format_pairs() {
        $map = array(
            array(
                "a" => "A",
                "b" => "B",
    ...
    public function test_format_table() {
        $table = null;
        $prefix = '';
    ...
    public function test_lines_wrap() {
        $text = null;
        $prefix = '';
        $suffix = '';
    ...
    public function test_remove_line_comments() {
        $data = null;
        $line_comment = '#';
        $alone = true;
    ...
    public function test_set_line_breaks() {
        $string = null;
        $br = "\n";
     ...
     */
    public function test_parse_columns($content, array $expected) {
