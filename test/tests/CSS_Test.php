...
class CSS_Test extends Test_Unit {
    public function test_color_parse() {
        $text = null;
        $default = null;
    ...
    public function test_color_lookup() {
        $text = null;
        $default = null;
        CSS::color_lookup($text, $default);
    }

    public function test_color_format() {
        $rgb = null;
        $default = null;
        CSS::color_format($rgb, $default);
    }

    public function test_color_normalize() {
        $text = null;
        $default = null;
        CSS::color_normalize($text, $default);
    }

    public function test_color_table() {
        CSS::color_table();
    }

    public function test_rgb_to_hex() {
        $rgb = null;
        $default = null;
