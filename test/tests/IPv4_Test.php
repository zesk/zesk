...
class IPv4_Test extends Test_Unit {
	...
	public function test_mask_to_string() {
		$ip = null;
		$ipbits = 32;
	...
	public function test_subnet_mask() {
		for ($n = 1; $n <= 32; $n++) {
	...
	public function test_subnet_mask_not() {
		$ipbits = null;
	...
	public function test_within_network() {
		$ip = null;
		$network = null;
