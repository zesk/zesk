...
<?php
/**
 * $URL: https://code.marketacumen.com/zesk/trunk/test/classes/xml/rpc/client/XML_RPC_Client_Multicall-urlHeaders.phpt $
 * @package zesk
 * @subpackage test
...
XML_RPC_Client_Multicall::urlHeaders($url);
