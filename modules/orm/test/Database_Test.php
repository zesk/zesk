...
class Database_Test extends Test_Unit {
    ...
    public function test_query_array_index() {
        $db = $this->application->database_registry();
    ...
    public function test_auto_table_names() {
        $db = $this->application->database_registry();
    ...
    public function test_auto_table_names_options() {
        $db = $this->application->database_registry();
    ...
    public function test_auto_table_names_replace() {
        $db = $this->application->database_registry();
    ...
    public function test_bytes_used() {
        $db = $this->application->database_registry();
    ...
    public function test_query_one() {
        $db = $this->application->database_registry();
    ...
    public function test_query_integer() {
        $db = $this->application->database_registry();
    ...
    public function test_query_one1() {
        $db = $this->application->database_registry();
    ...
    public function test_select_one_where() {
        $db = $this->application->database_registry();
    ...
    public function test_update_id_test() {
        $db = $this->application->database_registry();
