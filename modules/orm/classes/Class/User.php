...
class Class_User extends Class_ORM {
	 ...
	 * @var string
	 */
	public $column_password_is_binary = false;
	 ...
	 * @var string
	 */
	public $column_hash_method = "hash_method";
	 ...
	 * @var string
	 */
	public $default_hash_method = "md5";
