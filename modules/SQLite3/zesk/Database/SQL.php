...
class Database_SQL extends \zesk\Database_SQL {
	...
	public function alter_table_change_column(Database_Table $table, Database_Column $oldColumn, Database_Column $newColumn) {
	 ...
	 */
	public function alter_table_type($tableName, $newType) {
		return [];
	}
	 ...
	 * String Comparison
	 */
	public function function_compare_binary($columnName, $cmp, $string) {
	...
	public function createTable(Database_Table $table): void {
