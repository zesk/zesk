<?php
/**
 * $URL: https://code.marketacumen.com/zesk/trunk/modules/csv/classes/CSV.php $
 * @package zesk
 * @subpackage tools
...
abstract class CSV extends Options {
	 ...
	 * @return CSV
	 */
	function add_headers(array $headers, $is_map = true) {
		if ($is_map) {
	 ...
	 * @return CSV
	 */
	function set_headers(array $headers, $is_map = true) {
		$this->Headers = array();
	 ...
	 * @return string
	 */
	function column($name, $default = false) {
		$name = strtolower($name);
