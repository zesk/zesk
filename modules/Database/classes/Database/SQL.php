...
abstract class Database_SQL extends Hookable {
	 ...
	 * @return string|array
	 */
	abstract public function alter_table_index_add(Database_Table $table, Database_Index $index): string|array;
	 ...
	 * @return string|array
	 */
	abstract public function alter_table_attributes(Database_Table $table, array $attributes): string|array;
	 ...
	 * @param Database_Table $table
	 *            The table to alter
	 * @param Database_Column $oldColumn
	 * @param Database_Column $newColumn
	 * @return string SQL statement to alter a table's definition
	 */
	abstract public function alter_table_change_column(Database_Table $table, Database_Column $oldColumn, Database_Column $newColumn): string;
	 ...
	 * @return string SQL statement to alter a table's definition
	 */
	public function alter_table_column_drop(Database_Table $table, string $columnName): string {
	 ...
	 * @return string|array
	 */
	abstract public function alter_table_type(string $tableName, string $newType): string|array;
	 ...
	 */
	abstract public function createTable(Database_Table $table): array;
	 ...
	 */
	abstract public function drop_table(string $mixed): array;
	 ...
	 */
	abstract public function function_compare_binary(string $columnName, string $cmp, string $string): string;
	 ...
	 * @return array
	 */
	public function to_database(Model $object, array $data, bool $insert = false): array {
		return $data;
	}
	 ...
	 * @return array
	 */
	public function from_database(Model $object, array $data): array {
		return $data;
	}
