<?php
/**
 * $URL: https://code.marketacumen.com/zesk/trunk/classes/Control/Checklist.php $
 * @package zesk
 * @subpackage widgets
...
class Control_Checklist extends Control_Optionss {
	...
	protected function hook_object_value() {
		if ($this->value_is_list()) {
			return arr::flip_copy(to_list($this->value(), to_list($this->default_value(), array()), $this->option_separator()));
		}
		return $this->value();
	}
	/**
