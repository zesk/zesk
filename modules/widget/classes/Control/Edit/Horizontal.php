...
class Control_Edit_Horizontal extends Control_Edit {
	...
	protected function initialize(): void {
		...
		$this->label_attributes = HTML::addClass($this->label_attributes, "col-sm-$quarter");
		$this->widget_wrap_attributes = HTML::addClass($this->widget_wrap_attributes, "col-sm-$three_quarters");
		$this->nolabel_widget_wrap_attributes = HTML::addClass($this->nolabel_widget_wrap_attributes, "col-sm-$ncols");
	}
}
