/*
 * $Id: jquery.timer.js 2250 2014-03-05 22:31:28Z kent $
 *
...
!function($) {
	 ...
	 *
	 * @param integer delta Number of seconds to output
	...
	Timer.prototype.tick = function () {
		var now = (new Date()).getTime(), 
			format, 
			delta = parseInt(Math.abs(now - this.date.getTime()) / 1000, 10), 
			unit_sec = units[this.unitMinimum] || 1, 
			isZero = parseInt(delta / unit_sec, 10) === 0,
			isPast = now > this.date.getTime();
