...
<div class="error">
	...
	<ul>
		<li><a href="http://zesk.com/database-exception-connect#running">That it's running.</a></li>
		<li><a href="http://zesk.com/database-exception-connect#credentials">That the access credentials are correctly configured.</a></li>
	</ul>
