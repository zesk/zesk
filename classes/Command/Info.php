...
class Command_Info extends Command_Base {
	 ...
	 * @var string
	 */
	public const zesk_application_themePath = "zesk\Application::themePath";
	...
	public static $human_names = [
		...
		self::zesk_application_themePath => 'Application Theme Path',
	...
	public function run(): int {
		...
		$info[self::zesk_application_themePath] = $app->themePath();
