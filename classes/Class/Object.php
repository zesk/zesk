...
class Class_Object extends Hookable {
	...
	/**
	 * Convert data to/from a JSON string in the database. Column should be a blob (not text)
	 * @var string
	 */
	...
	/**
	 * Application class associated with this Class_Object
	 * 
	 * @var string
	 */
	 ...
	 * structure. If this is empty, it is generated based on other settings.
	 ...
	 * set to false for Bear, Bear_Fuzzy, Bear_Bare all using respective Class_Bear, Class_Bear_Fuzzy, Class_Bear_Bare depending on polymorphic state.
	 *
	 * The latter (false) allows you to have objects whose data representation (linked objects) changes depending on polymorphic class setup.
	 *
	...
	/**
	 * <code>
	 * protected $schema_file = 'MyObject.sql';
	 * </code>
	 ...
	 * global "Object::utc_timestamps", then true.
	 *
	 * @var boolean
	 */
	 ...
	 * Set by Object class, read-only by subclasses
	 *
	 * @var boolean
	 */
	...
	/**
	 * Function to call to get a field as implemented in Object subclass (not Class_Object subclass!)
	 * Method should be identical to __get prototype. (Allows reuse.)
	 *
	 * @var array
	 */
	...
	/**
	 * Function to call to set a field as implemented in Object subclass (not Class_Object subclass!)
	 * Method should be identical to __set prototype. (Allows reuse.)
	 *
	 * @var array
	 */
	 ...
	 *
	 * You can dynamically set the class using another member by specifying a "*" before the other member name instead of a class
	 * name.
	 *
	 * So:
	 *
	...
	/**
	 * When converting to JSON, use these options by default. Parameter options take precedence over these.
	 * 
	 * @var array
	 */
	...
	/**
	 * If you modify the database structure dynamically, you should call this to force column recomputation
	 */
	...
	/**
	 * Handle namespace objects intelligently and preserve namespace (\ group), prefixing class name (_ group)
	 * 
	 * @inline_test assertEqual(Class_Object::object_to_class('zesk\Dude'), 'zesk\Class_Dude');
	 * @inline_test assertEqual(Class_Object::object_to_class('a\b\c\d\e\f\g\Dude'), 'a\b\c\d\e\f\g\Class_Dude');
	...
	/**
	 * Create a new class instance - should only be called from Object
	 *
	 * @param Object $object
	 * @return Zesk_Class
	 */
	 ...
	 *
	 * @param string $class
	 * @param string $member Member name to use for iteration, etc.
	 * @param array $many_spec Many specification
	 ...
	 */
	protected function configure(Object $object) {
	}
	/**
	...
	final public function link_walk(Object $object, Database_Query_Select $query, $mixed = null) {
	 ...
	 * @todo implement this
	 */
	final public function _has_many_query_update(Object $this_object, Database_Query_Update $query, array $many_spec, &$alias = "J", $link_alias = null, $join_type = true, $reverse = false) {
	 ...
	 */
	final public function has_many_query_default(Object $object, array $many_spec, $alias = "J", $reverse = false) {
	 ...
	 */
	final public function has_many_query_update_default(Object $object, array $many_spec, $alias = "J", $reverse = false) {
		$query = $many_spec['object']->query_update($alias);
		$this->_has_many_query_update($object, $query, $many_spec, $alias, null, true, $reverse);
		return $query;
	}
	private function has_many_query(Object $object, $member) {
		$many_spec = $this->has_many($this, $member);
		if ($many_spec === null) {
			throw new Exception_Semantics("Object::has_many_query on non-many column: $member");
		}
	 ...
	 * @param string $member
	 * @param Object $object Returned object class which represents the target object type
	 * @return Database_Query_Select
	 * @throws Exception_Semantics
	 */
	final public function member_query(Object $this_object, $member, &$object = null) {
	 ...
	 * @throws Exception_Semantics
	 */
	final public function member_query_update(Object $this_object, $member, &$object = null) {
		if (!isset($this->has_many[$member])) {
			throw new Exception_Semantics($this->class . "::member_query($member) called on non-many member");
		}
		$many_spec = $this->has_many($this_object, $member);
	 ...
	 */
	final public function member_foreign_list(Object $object, $member) {
		if (!isset($this->has_many[$member])) {
	...
	final public function member_foreign_exists(Object $object, $member, $id) {
		if (!isset($this->has_many[$member])) {
	...
	final public function member_foreign_delete(Object $object, $member) {
		if (!isset($this->has_many[$member])) {
	...
	final public function member_foreign_add(Object $this_object, $member, Object $link) {
		if (!isset($this->has_many[$member])) {
	...
	private function has_many_init(Object $object, array $has_many) {
		...
		if ($this->inherit_options) {
			...
			$object = $object->object_factory($class, null, $object->inherit_options());
		}
		if (!$object instanceof Object) {
			throw new Exception_Semantics("{class} is not an instance of Object", compact("class"));
		}
		if ($table === true) {
			// Clean up reference
	 ...
	 * @return Database_Schema
	 */
	final public function database_schema(Object $object = null) {
	 ...
	 * @return Database_Schema
	 */
	public function schema(Object $object) {
	 ...
	 * @return array
	 */
	final public function from_database(Object $object, array $data) {
		$result = array();
		$column_types = $this->column_types;
	 ...
	 * @return array
	 */
	final public function from_array(Object $object, array $data) {
		$column_types = $this->column_types;
		$columns = array_keys(count($data) < count($column_types) ? $data : $column_types);
		foreach ($columns as $column) {
			if (!array_key_exists($column, $column_types) || !array_key_exists($column, $data)) {
	 ...
	 * @return array
	 */
	final public function to_database(Object $object, array $data, $insert = false) {
	...
	/**
	 * Generate the desired zesk Object class name to instantiate this object
	 *
	...
	/**
	 * Convert the existing Object class name to the preferred code used in the database
	 *
	 * Override in subclasses to get different polymorphic behavior.
	 *
	 * @param Object $object
	 * @param string $column Column which is generating this value
	 * @return string
	 */
	protected function polymorphic_class_parse(Object $object, $column) {
	 ...
	 * @return multitype:string
	 */
	private function member_from_array(Object $object, $column, $type, array &$data) {
		switch ($type) {
			case self::type_hex:
			case self::type_hex32:
			case self::type_serialize:
	 ...
	 * @return string
	 */
	private function sql_now(Object $object) {
	 ...
	 * @throws Exception_Semantics
	 */
	final public function member_to_database(Object $object, $column, $type, array &$data, $insert = false) {
		...
		switch ($type) {
			...
			case self::type_string:
				...
				break;
			case self::type_object:
				$data[$column] = $v === null ? null : Object::mixed_to_id($v);
				break;
