...
class Adapter_CacheItem implements CacheItemInterface {
	 ...
	 * @param string $key
	 */
	public function __construct($key, $value, $is_hit = null, Timestamp $expiration = null) {
		$this->key = $key;
		$this->value = $value;
		$this->is_hit = boolval($is_hit);
		if ($expiration) {
	 ...
	 * 
	 */
	public function _handle_expiration() {
		if ($this->expiration && $this->expiration->beforeNow()) {
			$this->value = null;
			$this->is_hit = false;
