...
class ArrayTools {
	 ...
	 * @return array
	 */
	static function capitalize(array $array) {
	 ...
	 * @see flatten
	 */
	static function flatten(array $a) {
		foreach ($a as $k => $v) {
			if (!is_scalar($v)) {
				$a[$k] = flatten($v);
			}
	 ...
	 * @see flatten
	 */
	static function simplify(array $a) {
		foreach ($a as $k => $v) {
			if (is_object($v)) {
	 ...
	 * @see trim()
	 */
	static function trim(array $a, $charlist = self::TRIM_WHITESPACE) {
		foreach ($a as $i => $v) {
	 ...
	 * @see trim()
	 */
	static function rtrim($a, $charlist = self::TRIM_WHITESPACE) {
		if (!is_array($a)) {
	 ...
	 * @see trim()
	 */
	static function ltrim($a, $charlist = self::TRIM_WHITESPACE) {
		if (!is_array($a)) {
	 ...
	 * @return array
	 */
	static function prefix(array $arr, $str) {
		foreach ($arr as $k => $v) {
			$arr[$k] = $str . $v;
		}
		return $arr;
	 ...
	 * @return array
	 */
	static function suffix(array $arr, $str) {
		foreach ($arr as $k => $v) {
			$arr[$k] = $v . $str;
		}
		return $arr;
	 ...
	 * @return array
	 */
	static function wrap(array $arr, $prefix = "", $suffix = "") {
		foreach ($arr as $k => $v) {
	 ...
	 * @return array
	 */
	static function kprefix(array $arr, $str) {
		$result = array();
		foreach ($arr as $k => $v) {
			$result[$str . $k] = $v;
		}
	 ...
	 * @return array
	 */
	static function ksuffix(array $arr, $str) {
		$result = array();
		foreach ($arr as $k => $v) {
			$result[$k . $str] = $v;
		}
	 ...
	 * @return array
	 */
	static function kwrap(array $arr, $prefix = "", $suffix = "") {
		$result = array();
		foreach ($arr as $k => $v) {
	 ...
	 * @return array
	 */
	static function unprefix(array $arr, $str, $remove = false) {
		$n = strlen($str);
		foreach ($arr as $k => $v) {
			if (is_string($v)) {
				if (begins($v, $str)) {
	 ...
	 * @return array
	 */
	static function unsuffix(array $arr, $str, $remove = false) {
		$n = strlen($str);
		foreach ($arr as $k => $v) {
			if (is_string($v)) {
				if (ends($v, $str)) {
	 ...
	 * @return array
	 */
	static function unwrap(array $arr, $prefix, $suffix, $remove = false) {
	 ...
	 * @return array
	 */
	static function kunprefix(array $arr, $str, $remove = false) {
		$n = strlen($str);
		$result = array();
		foreach ($arr as $k => $v) {
			if (substr($k, 0, $n) === $str) {
	 ...
	 * @return array
	 */
	static function kunsuffix(array $arr, $str, $remove = false) {
		$n = strlen($str);
		$result = array();
		foreach ($arr as $k => $v) {
			if (substr($k, -$n) === $str) {
