...
abstract class Database_SQL extends Hookable {
	 ...
	 * @return string|array
	 */
	abstract function alter_table_index_add(Database_Table $table, Database_Index $index);
	 ...
	 * @return string|array
	 */
	abstract function alter_table_attributes(Database_Table $table, array $attributes);
	...
	abstract function alter_table_type($table, $type);
	 ...
	 * @param string $alias
	 */
	abstract function sql_function($func, $memberName, $alias = "");
	 ...
	 * @return unknown
	 */
	function database_table_as($database, $table, $name = "") {
	 ...
	 * @return unknown
	 */
	function column_alias($column, $alias = "") {
		if (is_array($column)) {
	 ...
	 * @return unknown
	 */
	function column_as($column, $alias = "") {
		if (is_array($column)) {
			foreach ($column as $index => $col) {
	 ...
	 * @param string $name
	 */
	abstract function quote_table($name);
	 ...
	 * @param string $text
	 */
	abstract function quote_text($text);
	/**
	 *
	 * @return string array
	 * @param string|array $name
	 */
	abstract function quote_column($name);
	 ...
	 * @return string
	 */
	abstract function unquote_column($name);
	 ...
	 * @return string
	 */
	abstract function unquote_table($name);
