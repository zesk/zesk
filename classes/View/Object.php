<?php
/**
 * $URL: https://code.marketacumen.com/zesk/trunk/classes/View/Object.php $
 * @package zesk
 * @subpackage widgets
 ...
 *
 */
class View_Object extends View {
	...
	function display_method($set = null, $set_args = array()) {
		if ($set !== null) {
	...
	function theme_variables() {
		return array(
			...
			"class_object" => $this->application->class_object($this->option('class', $this->class))
