...
class Role extends ORMBase {
	...
	public static function root_id(Application $application): int {
		return $application->ormRegistry(__CLASS__)->querySelect()->addWhat('id', 'id')->addWhere('is_root', true)->integer('id', 0);
	}
	...
	public static function default_id(Application $application): int {
		return $application->ormRegistry(__CLASS__)->querySelect()->addWhat('id', 'id')->addWhere('is_default', true)->integer('id', 0);
	}
